            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    <h5 class="pt-2">Add Media Language</h5>
                                </div>
                    	...
                    	<div class="card-body">
                    		<form id="saveLanguage" method="post" action="language/save">
                    			@csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                            ...
                                            <div id="data_details" class="tab-pane fade in active show">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input class="form-control required" type="text" id="language_code" name="language_code" oninput="validateNameInput(this)"><br/>
                                                    </div>
                                                    <div class="col-sm-6">
                        		...
                        		<div class="row">
                        			<div class="col-sm-12">
                        				<div class="pull-right">
                        					<button type="button" class="btn btn-success" onclick="submitForm('saveLanguage','post')">Submit</button>
