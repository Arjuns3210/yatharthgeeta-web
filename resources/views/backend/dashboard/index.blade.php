        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                <section id="minimal-statistics">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="content-header">Welcome to Admin Panel</h1>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body text-left">
                                                <h3 class="mb-1 success">25</h3>
                                                <span>Categories</span><br><br><br>
                                            </div>
