                                                ...
                                                <form method="post" id="ForceTochangePwd" action="force_reset_password">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <input class="form-control" type="password" name="new_password" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\W).{8,}" title="Password must be at least 8 characters long and contain at least 1 uppercase letter, 1 lowercase letter, and 1 special character." required><br>
                                                        </div>  
                                                        <div class="col-md-12">
                                                            <label>Confirm Password<span class="text-danger">*</span></label>
                                                            <input class="form-control" type="password" name="confirm_password" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\W).{8,}" title="Password must be at least 8 characters long and contain at least 1 uppercase letter, 1 lowercase letter, and 1 special character." required><br>
