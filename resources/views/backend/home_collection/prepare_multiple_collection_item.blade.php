<div class="col-md-12 main_div_multiple mb-0">
    <div class="row">
        <div class="col-md-3 mt-1">
            <input type="file" class="form-control required"  name="img_file[]" accept=".jpg,.jpeg,.png"><br/>
        </div>
        ...
        <div class="col-md-3 mt-1">
            <select class="select2  mapped-ids required"  name="mapped_ids[{{$count}}][]" multiple style="width: 100% !important;" >
