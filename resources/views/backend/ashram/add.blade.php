                    		...
                    		<form id="saveAshram" method="post" action="ashram/save">
                        		...
                        		<div class="row">
                        			<div class="col-sm-6">
                        				...
                        				<input class="form-control required" type="text" id="name" name="name" oninput="validateNameInput(this)"><br/>
                        			</div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control required" type="text" id="phone" name="phone" oninput="filterNonNumeric(this)"><br/>
                                    </div>
                                    <div class="col-sm-6">
