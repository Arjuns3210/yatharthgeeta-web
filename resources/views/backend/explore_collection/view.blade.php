                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    <h5 class="pt-2">View Explore Collection: {{ $collection->title ?? '' }} ({{ config('translatable.locales_name')[\App::getLocale()] }})</h5>
                                </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered">
                                                            <tr>
                                                                ...
                                                                <td>{{\App\Models\ExploreCollection::EXPLORE_COLLECTION_TYPES[$collection->type] ?? ''}}</td>
                                                            </tr>
                                                            <tr>
