                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped  datatable" id="dataTable" width="100%" cellspacing="0" data-url="explore_collection/fetch">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        @if($data['explore_collection_edit'] || $data['explore_collection_view'] || $data['explore_collection_status'])
