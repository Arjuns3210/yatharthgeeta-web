                                            ...
                                            <div id="data_details" class="tab-pane fade in active show">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control required" id="book_category_id" name="book_category_id">
                                                        @foreach($book_category as $book_cat)
                                                                <option value="{{$book_cat->id}}">{{$book_cat->name}}</option>
                                                        @endforeach
                                                        </select><br/>
                                                    </div>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-lg-12 col-sm-6 text-center">
                                                        ...
                                                        <p style="color:blue;">Note : Upload file size {{config('global.dimensions.books_width')}}X{{config('global.dimensions.books_height')}} pixel and .jpg, .png, or jpeg format image</p>
                                                        <div class="shadow bg-white rounded d-inline-block mb-2">
                                                            <div class="input-file">
                                                                <label class="label-input-file">Choose Files &nbsp;&nbsp;&nbsp;<i class="ft-upload font-medium-1"></i>
