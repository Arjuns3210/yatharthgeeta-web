            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                    	...
                    	<div class="card-body">
                    		<form id="savemantra" method="post" action="mantras/save">
                    			@csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                            ...
                                            <div id="data_details" class="tab-pane fade in active show">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <textarea class="form-control required" type="text" id="sanskrit_title" name="sanskrit_title"></textarea> <br/>
                                                    </div>
                                                    <div class="col-sm-6">
                        		...
                        		<div class="row">
                        			<div class="col-sm-12">
                        				<div class="pull-right">
                        					<button type="button" class="btn btn-success" onclick="submitForm('savemantra','post')">Submit</button>
