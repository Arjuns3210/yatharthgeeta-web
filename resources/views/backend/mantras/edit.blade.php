                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    <h5 class="pt-2">Edit Mantra Details : {{$mantras['sanskrit_title']}}({{ config('translatable.locales_name')[\App::getLocale()] }})</h5>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="tab-content">
                                            <div id="data_details" class="tab-pane fade in active show">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <label>Sanskrit Mantra<span class="text-danger">*</span></label>
                                                        <textarea class="form-control required" type="text" id="sanskrit_title" name="sanskrit_title">{{$mantras->sanskrit_title}}</textarea><br/>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label>Sequence<span class="text-danger">*</span></label>
                                                        <input class="form-control required integer-validation" type="number" id="sequence" name="sequence" value="{{$mantras->sequence}}"><br/>
                                                    </div>
                                                </div>
                                            </div>
                                                         ...
                                                         ?>
                                                            ...
                                                            <?php if($translated_block_fields_value == 'input') { ?>
                                                                <div class="col-md-6 mb-3">
                                                                    <label>Mantra {{$translated_block_fields_key}}<span class="text-danger">*</span></label>
