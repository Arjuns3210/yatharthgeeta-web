                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    <h5 class="pt-2">View Mantra : {{$mantras['sanskrit_title']}}({{ config('translatable.locales_name')[\App::getLocale()] }})</h5>
                                </div>
                                        ...
                                        <div id="data_details" class="tab-pane fade in active show">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
                                                    <tr>
                                                        <td><strong>Sanskrit Mantra</strong></td>
                                                        <td><?php echo str_replace("\n", "<br/>", $mantras->sanskrit_title) ?? '' ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Sequence</strong></td>
                                                        <td>{{ $mantras->sequence ?? ''}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Status</strong></td>
                                                        <td><?php echo $mantras['status'] == 1 ? 'Active' : 'Inactive' ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered">
                                                            <?php foreach ($translated_block as $translated_block_fields_key => $translated_block_fields_value) { ?>
                                                                    <tr>
                                                                        <td><strong>Mantra {{ucfirst($translated_block_fields_key)}}</strong></td>
                                                                        <td><?php echo $mantras[$translated_block_fields_key.'_'.$translated_data_tabs] ?? '' ?></td>
                                                                    </tr>
                                                            <?php } ?>
                                                        </table>
                                                    </div>
